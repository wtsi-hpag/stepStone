...
//        printf("fgets command error:\n);
    ...
    strncpy(Comname[0],"A-tumor",7);
    strncpy(Comname[1],"B-tumor",7);
    strncpy(Comname[2],"C-tumor",7);
    strncpy(Comname[3],"D-tumor",7);
    strncpy(Comname[4],"E-tumor",7);
    strncpy(Comname[5],"A-conto",7);
    strncpy(Comname[6],"B-conto",7);
    strncpy(Comname[7],"C-conto",7);
    strncpy(Comname[8],"D-conto",7);
    strncpy(Comname[9],"E-conto",7);
...
/*      search reads with an index > i     */
	   ...
	   {
             for(n=i;n<j;n++)
                fprintf(namef2,"%d %d %d %d %d %s\n",hit_index1[n],hit_locus1[n],hit_index2[n],hit_locus2[n],hit_reads[n],Samname[n]);
	   }
        }
        else
        {
