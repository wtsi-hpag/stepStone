...
/*                  for(n=0;n<r_len;n++)
             ...
             num_INDs = 0; 
             num_GAPs = 0;
             if(((strncmp(refname,"chr",3)) == 0)&&(strlen(refname) <=6))
             {
               int idt = 0;
               ...
               else if((strncmp(refname,"chrM",4)) == 0)
               {
                 idt = 25;
               }
               else
...
//                 printf("Break1: %d %d %s %d %d %d %d %d\n",num_align,idt,ctgname[num_align],hitst,hitst,r_offset,s_offset,seq_len-1);
	       ...
	       {
		 if(long_flag == 1)
                   fprintf(namef2,"%d %d %d %s %d %d %d\n",ctg_rcdex[num_align],num_align,idt,ctgname[num_align],hitst,hitst,r_offset);
		 else
	         {
		   if(s_offset >= 127)
                     fprintf(namef2,"%d %d %d %s %d %d %d\n",ctg_rcdex[num_align],num_align,idt,ctgname[num_align],hitst,hitst,r_offset);
